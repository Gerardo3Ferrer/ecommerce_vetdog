...
<head>
    ...
    <title>El conejo de la luna 18</title>
                                ...
                                <div class="search-box-inner-wrap">
                                    <form class="search-box-inner">
                                        <div class="search-field-wrap">
                                            <input type="text" class="search-field" placeholder="Tus productos de anime favorito ¡encuéntralos aquí!">
                                        </div>
                    ...
                    <div class="col-12">
                        <div class="hero-slider-active slick-dot-style">
                            ...
                            <div class="hero-item-inner">
                                <div class="hero-slider-item d-flex align-items-center bg-img" data-bg="../assets/img/slider/slider.jpg">
    ...
    <footer class="footer-wrapper">
                        ...
                        <div class="fotter-widget-item">
                            ...
                            <div class="support-widget-body">
                                <div class="usefull-links">
                                    <ul>
                                        <li><a href="#">Ventajas de El conejo de la luna 18</a></li>
                                      
                                        <li><a href="#">Opiniones sobre El conejo de la luna 18</a></li>
        ...
        <div class="footer-bottom-area bg-white">
            <div class="copyright-text">
                <p>&copy; 2021 <b>El Conejo de la luna 18</p>
            </div>
        </div>
